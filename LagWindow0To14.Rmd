...
for(i in seq(length(dlist))) {
  ...
  data$templag8<-Lag(data$temp,8)
  data$templag9<-Lag(data$temp,9)
  data$templag10<-Lag(data$temp,10)
  data$templag11<-Lag(data$temp,11)
  data$templag12<-Lag(data$temp,12)
  data$templag13<-Lag(data$temp,13)
  data$templag14<-Lag(data$temp,14)
...
lags <-  c("prcp95th_lag0","prcp95th_lag1","prcp95th_lag2","prcp95th_lag3","prcp95th_lag4","prcp95th_lag5","prcp95th_lag6", "prcp95th_lag7", "prcp95th_lag8", "prcp95th_lag9", "prcp95th_lag10", "prcp95th_lag11", "prcp95th_lag12", "prcp95th_lag13", "prcp95th_lag14")
...
holder$Analysis <- "Lag014"
#write.csv(holder, "/Users/kevin/Documents/ChenLabResearch/HurricaneProject/Coding/PostJournalComments/Lag014.csv")
```
